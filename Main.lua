...
-- Notification drag areas (taller and more visible)
local notifTopDrag = Instance.new("Frame")
notifTopDrag.Size = UDim2.new(1, 0, 0, 20) -- Taller drag area
notifTopDrag.Position = UDim2.new(0, 0, 0, 0)
notifTopDrag.BackgroundColor3 = Color3.new(1, 1, 1)
notifTopDrag.BackgroundTransparency = 0.8 -- Semi-transparent
notifTopDrag.ZIndex = 101
notifTopDrag.Parent = notificationFrame

local notifBottomDrag = Instance.new("Frame")
notifBottomDrag.Size = UDim2.new(1, 0, 0, 20) -- Taller drag area
notifBottomDrag.Position = UDim2.new(0, 0, 1, -20)
notifBottomDrag.BackgroundColor3 = Color3.new(1, 1, 1)
notifBottomDrag.BackgroundTransparency = 0.8 -- Semi-transparent
notifBottomDrag.ZIndex = 101
...
notificationSubLabel.ZIndex = 102
...
-- Enhanced drag lines (taller and more visible)
local bottomDragLine = Instance.new("Frame")
bottomDragLine.Size = UDim2.new(1, 0, 0, 15) -- Taller drag area
bottomDragLine.Position = UDim2.new(0, 0, 1, -15)
bottomDragLine.BackgroundColor3 = Color3.new(1, 1, 1)
bottomDragLine.BackgroundTransparency = 0.8 -- Semi-transparent
bottomDragLine.BorderSizePixel = 0
bottomDragLine.ZIndex = 2
bottomDragLine.Parent = frame

local leftDragLine = Instance.new("Frame")
leftDragLine.Size = UDim2.new(0, 15, 1, -60) -- Taller drag area
leftDragLine.Position = UDim2.new(0, 0, 0, 30)
leftDragLine.BackgroundColor3 = Color3.new(1, 1, 1)
leftDragLine.BackgroundTransparency = 0.8 -- Semi-transparent
leftDragLine.ZIndex = 2
leftDragLine.Parent = frame

local rightDragLine = Instance.new("Frame")
rightDragLine.Size = UDim2.new(0, 15, 1, -60) -- Taller drag area
rightDragLine.Position = UDim2.new(1, -15, 0, 30)
rightDragLine.BackgroundColor3 = Color3.new(1, 1, 1)
rightDragLine.BackgroundTransparency = 0.8 -- Semi-transparent
...
if isMobile() then
    ...
    -- Make drag areas even more visible on mobile
    bottomDragLine.BackgroundTransparency = 0.7
    leftDragLine.BackgroundTransparency = 0.7
    rightDragLine.BackgroundTransparency = 0.7
    notifTopDrag.BackgroundTransparency = 0.7
    notifBottomDrag.BackgroundTransparency = 0.7
end
...
showNotification(
    ...
    "• Drag from any edge to move windows",
    6
)

-- Create example tabs with content
local mainTab = createTab("Main")
local settingsTab = createTab("Settings")
local toolsTab = createTab("Tools")

-- Add content to main tab
createLabel(mainTab, "MAIN CONTROLS", UDim2.new(1, 0, 0, 25), "section")
createToggle(mainTab, "Enable Feature", false, function(state) 
    showNotification("Feature " .. (state and "enabled" or "disabled"), 2)
end)
createSlider(mainTab, "Volume Level", 0, 100, 50, function(value)
    showNotification("Volume set to: " .. value, 1)
end)
createButton(mainTab, "Test Button", function()
    showNotification("Button pressed!", 2)
end)

-- Add content to settings tab
createLabel(settingsTab, "CONFIGURATION", UDim2.new(1, 0, 0, 25), "section")
createToggle(settingsTab, "Dark Mode", true, function(state) end)
createSlider(settingsTab, "UI Scale", 50, 150, 100, function(value) end)
local settingsDropdown = createDropdown(settingsTab, "Options")
settingsDropdown.addButton("Reset Settings", function() end)
settingsDropdown.addToggle("Advanced Mode", false, function(state) end)

-- Add content to tools tab
createLabel(toolsTab, "UTILITIES", UDim2.new(1, 0, 0, 25), "section")
